<!DOCTYPE html>
      ...
      <?php //Yii::app()->clientscript
		//->registerCssFile( '/otlistcreater/theme/css/bootstrap.min.css' ,CClientScript::POS_HEAD   )
		//->registerCssFile( Yii::app()->theme->baseUrl . '/css/custom-theme/jquery-ui-1.10.0.custom.css' ,CClientScript::POS_HEAD   )
		//->registerCssFile( Yii::app()->theme->baseUrl . '/css/font-awesome.min.css' ,CClientScript::POS_HEAD   )
		//->registerCssFile( Yii::app()->theme->baseUrl . '/css/docs.css' ,CClientScript::POS_HEAD   )
		//->registerCssFile( Yii::app()->theme->baseUrl . '/js/google-code-prettify/prettify.css' ,CClientScript::POS_HEAD   )
                         ?>
        <!-- Navbar
        ================================================== -->
...
<?php // Yii::app()->clientscript->registerCoreScript( 'jquery' )
        // ->registerScriptFile( Yii::app()->theme->baseUrl . '/js/jquery-1.9.0.min.js', CClientScript::POS_END )
        // ->registerScriptFile( Yii::app()->theme->baseUrl . '/js/bootstrap.min.js', CClientScript::POS_END )
        // ->registerScriptFile( Yii::app()->theme->baseUrl . '/js/jquery-ui-1.10.0.custom.min.js', CClientScript::POS_END )
        // ->registerScriptFile( Yii::app()->theme->baseUrl . '/js/google-code-prettify/prettify.js', CClientScript::POS_END )
        // ->registerScriptFile( Yii::app()->theme->baseUrl . '/js/docs.js', CClientScript::POS_END )
        // ->registerScriptFile( Yii::app()->theme->baseUrl . '/js/demo.js', CClientScript::POS_END )
        ?>
